...
<body class="gray-bg">
	...
	<!-- 统计 -->
	<div class="modal fade" id="modal_user_gjtj" role="dialog" aria-labelledby="modal_user_gjtj" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	//统计
		$("#btn_tj").click(function(){
		    ...
		    success:function(res){
		        ...
		        $('#modal_user_gjtj').modal({backdrop: 'static', keyboard: false});
    			$("#modal_user_gjtj").show();
		    }
		});
	}); 
